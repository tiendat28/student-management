    ...
    data(){
        return{
            items: [
                ...
                // {icon: 'mdi-flip-horizontal',text: 'Tự học', name: 'seltlearn'},
            ],
            a: null,
        }
    },
