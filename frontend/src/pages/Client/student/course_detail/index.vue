    ...
    <div class="flex w-full">
      <div class="bg-slate-200 w-[30%] h-full">
          <div class="h-[90px] flex justify-between items-center px-6">
            <router-link class="flex hover" :to="{ name: 'S_courses', params: { name: 'S_courses'}}">
  ...
  const Homepage = {
    data(){
          return{
            data: [],
            items: [
                  {icon: 'mdi-home',text: 'Trang chủ', name: 'S_course_id_homepage'},
                  {icon: 'mdi-comment-account',text: 'Điểm danh', name: 'S_attendance'},
